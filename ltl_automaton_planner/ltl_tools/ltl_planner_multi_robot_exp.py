...
class LTLPlanner_MultiRobot_Exp(object):
    ...
    def task_allocate(self, style='static'):
        ...
        print("任务序列正在规划中("+style+") ---")
        print("LTL Planner: Hard task is: "+str(self.hard_spec))
        print("LTL Planner: Soft task is: "+str(self.soft_spec))
        ...
        if style == 'static':
            ...
            if self.plans is None:
                ...
                print("LTL Planner: No valid plan has been found!")
                return False
        ...
        if style == 'Global':
            if self.team and self.plans:
                ...
                if self.plans is None:
                    ...
                    print("LTL Planner: No valid global reallocation plan has been found!")
                    return False
            else:
                ...
                print("LTL Planner: \"replanning_global: \" planning was requested but team model or previous plan was never built, aborting...")
                return False
        ...
        if style == 'Local_state_change':
            if self.team and self.plans:
                ...
                if self.local_plan is None:
                    ...
                    print("LTL Planner: Reusable path not found; Try local replanning")
                ...
                if self.local_plan is None:
                    ...
                    print("LTL Planner: No valid local plan has been found given state change! Try global option")
                    return False
                ...
                print("LTL Planner: \"replanning_local_state_change: \" planning was requested but team model or previous plan was never built, aborting...")
                return False
        ...
        if style == 'Local_ts_update':
            if self.team and self.plans:
                ...
                if self.local_plan is None:
                    ...
                    print("LTL Planner: No valid local plan has been found given TS updates! Try global option")
                    return False
            else:
                ...
                print("LTL Planner: \"replanning_local_ts_change: \" planning was requested but team model or previous plan was never built, aborting...")
                return False
    ...
    def replan_level_2(self):
        ...
        while (len(self.trace_dic[0]) == 0) and \
            ...
            print('Waiting for the trace callback from all agents')

        if self.task_allocate(style="Global"):
            return "Global", True

        # rospy.logerr("LTL Planner: No valid plan has been found for level 2!")
        print("LTL Planner: No valid plan has been found for level 2!")
        return "Error", False
    ...
    def replan_level_3(self):
        ...
        print("LTL Planner: No valid plan has been found for level 3!")
        return "Error", False
