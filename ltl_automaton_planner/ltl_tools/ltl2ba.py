...
def run_ltl2ba(formula):
    raw_output = check_output("/home/zyj/ltl_codedown/ltl_automaton_planner/ltl_automaton_planner/ltl2ba -f \"" + formula + "\"", shell=True)
...
def parse_ltl(formula):
    ...
    edges, accepts, init = parser.parse()
    return edges, accepts, init
